      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // if previous size is empty, use car as start point ref
            if(prev_size < 2)
            {
            ...
            //Fill up the rest of our path planner after fillling it with previous points,
            //here, we will always output total 50 points
